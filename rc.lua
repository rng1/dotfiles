...
--    awful.tag({ "sys", "gcc", "dev", "www", "med", "chat", "etc1", "etc2", "etc3" }, s, awful.layout.layouts[1])
    local names = {
    "一",
    "二",
    "三",
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s",
        ...
        {description = "take screenshot to clipboard", group = "utilities"}),
